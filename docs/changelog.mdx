---
title: "Changelog"
description: "Upstream BrowserOS changes tracked for PannamOS porting"
---

This page tracks upstream BrowserOS changes that may be candidates for future PannamOS porting. For the full upstream release history with download links, see [GitHub Releases](https://github.com/browseros-ai/BrowserOS/releases).
