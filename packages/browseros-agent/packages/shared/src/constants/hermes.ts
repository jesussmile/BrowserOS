...
export const HERMES_COMPOSE_PROJECT_NAME = 'pannamos-hermes'
...
// directory that backs this mount lives under the PannamOS-managed VM
...
/**
 * PannamOS LLM provider types Hermes can consume. The frontend filters
